...
//by kiok ahn
	...
	memset( pPhaseArray, 0xFF, sizeof(BYTE)*dx*dy);
	iplSobel16Hypotenuse( pSourceArray, pDstMagnitudeArray, pPhaseArray, dx, dy, *pThreshold );
